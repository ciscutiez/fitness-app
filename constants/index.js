...
export const bodyParts = [
  { name: 'back', image: require('../assets/images/back.jpg') },
  { name: 'cardio', image: require('../assets/images/cardio.jpg') },
  { name: 'chest', image: require('../assets/images/chest.jpg') },
  { name: 'lower arms', image: require('../assets/images/lower-arms.jpg') },
  { name: 'lower legs', image: require('../assets/images/lower-legs.jpg') },
  { name: 'neck', image: require('../assets/images/neck.png') },
  { name: 'shoulders', image: require('../assets/images/shoulders.jpg') },

  { name: 'upper arms', image: require('../assets/images/upper-arms.jpg') },
  { name: 'upper legs', image: require('../assets/images/upper-legs.jpg') },
  { name: 'waist', image: require('../assets/images/waist.jpg') },
];
...
export const demoExercise = [
  {
    ...
    gifUrl: 'https://v2.exercisedb.io/image/MkMWCZEEveBQwI',
    id: '3220',
    instructions: [
  ...
  },
  {
    bodyPart: 'cardio',
    equipment: 'body weight',
    gifUrl: 'https://v2.exercisedb.io/image/uW6qZ-tSl8LzF6',
    id: '3672',
    instructions: [
      'Stand with your feet shoulder-width apart.',
  ...
  },
  {
    bodyPart: 'cardio',
    equipment: 'body weight',
    gifUrl: 'https://v2.exercisedb.io/image/Q4Bw2mO2ds0hY1',
    id: '3360',
    instructions: [
  ...
  },
  {
    bodyPart: 'cardio',
    equipment: 'body weight',
    gifUrl: 'https://v2.exercisedb.io/image/Y3wb9FyEsS077Z',
    id: '1160',
    instructions: [
  ...
  },
  {
    ...
    gifUrl: 'https://v2.exercisedb.io/image/uttQNJa5S980tk',
    id: '2331',
    instructions: [
  ...
  },
  {
    bodyPart: 'cardio',
    equipment: 'dumbbell',
    gifUrl: 'https://v2.exercisedb.io/image/PPTYedUQauHjlM',
    id: '1201',
    instructions: [
  ...
  },
  {
    bodyPart: 'cardio',
    equipment: 'body weight',
    gifUrl: 'https://v2.exercisedb.io/image/LYvv8Kp6K2xjke',
    id: '3221',
    instructions: [
      'Stand with your feet shoulder-width apart.',
  ...
  },
  {
    bodyPart: 'cardio',
    equipment: 'body weight',
    gifUrl: 'https://v2.exercisedb.io/image/8tFgDe8-eOXcOx',
    id: '3636',
    instructions: [
  ...
  },
  {
    bodyPart: 'cardio',
    equipment: 'body weight',
    gifUrl: 'https://v2.exercisedb.io/image/un0Qow56Opq5NB',
    id: '0501',
    instructions: [
      'Start in a standing position with your feet shoulder-width apart.',
  ...
  },
  {
    bodyPart: 'cardio',
    equipment: 'body weight',
    gifUrl: 'https://v2.exercisedb.io/image/pro7IOyBeBejpv',
    id: '3224',
    instructions: [
